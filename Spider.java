...
public class Spider extends JFrame{
    ...
    private JLabel clickLabel = null; //右下角快捷发牌区
    private int c = 0; //当前牌的数量
    private int n = 0;
    private int a = 0;
    private int finish = 0;//完成牌的副数
    ...
    public Spider(){
        ...
        groundLabel = new JLabel[10];//空格方框
	...
	public void setGroundLabelZOrder(){
        for (int i = 0; i < 10; i++){
            /*顺序（105+i）确定了绘制组件的顺序；具有最高顺序的组件将第一个绘制，
  			具有较低顺序的组件将覆盖具有较高顺序的组件。 */
