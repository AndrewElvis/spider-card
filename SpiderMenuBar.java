...
public class SpiderMenuBar extends JMenuBar{
    ...
    JMenuItem jItemOpen = new JMenuItem("新游戏");
    JMenuItem jItemPlayAgain = new JMenuItem("发牌/D");
    ...
    JMenuItem jItemValid = new JMenuItem("显示可行操作/M");
    ...
    public SpiderMenuBar(Spider spider){
		...
		jNewGame.addMenuListener(new javax.swing.event.MenuListener() { 
            ...
            public void menuDeselected(javax.swing.event.MenuEvent e) {} //取消选择某个菜单时调用
            public void menuCanceled(javax.swing.event.MenuEvent e) {} //取消菜单时调用
        });
